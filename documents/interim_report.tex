...
\lstdefinelanguage{Java}{
	keywords={public, private, new, true, false, catch, throws, return, null, const, switch, var, if, in, while, do, else, case, break, try, alert},
	keywordstyle=\color{blue}\bfseries,
	ndkeywords={class, export, boolean, throw, implements, import, this},
	ndkeywordstyle=\color{darkgray}\bfseries,
	identifierstyle=\color{black},
...
\begin{lstlisting}[language=JavaScript, caption={First the token is checked to see if it is valid, which will be true if the tokenExpiry value is greater than the current time.}]
