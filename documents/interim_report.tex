...
The dashboard is the first screen that the user will see upon successfully logging in. The dashboard is separated into three sections, of which only one has information at the moment. This will greet the user, and show the amount of points which they currently have. This could change to their position in the leaderboard in the future when implemented. 
