...
Component Based Architecture refers to the idea that a system can be developed via the use of off-the-shelf components, assembled with well defined software architecture~\cite{GPOUR_COMPONENT}. Based on React, Next.JS uses this architecture by allowing developers to make use of reusable components, that contain logic and styling specific to it. This allows for a more organised codebase, making it easier to identify where any potential issues may lie should they appear.
