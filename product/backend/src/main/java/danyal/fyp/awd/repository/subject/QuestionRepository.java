...
public interface QuestionRepository extends JpaRepository<Question, Integer> {
    ...
    @Query("select new danyal.fyp.awd.dto.admin.QuestionDataDto(q.question, q.answer, q.marks, t.name, s.name) from Question q left join q.topic t left join t.subject s")
