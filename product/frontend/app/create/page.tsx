                ...
                <div className=" sm:mx-auto sm:w-full sm:max-w-lg bg-[#D9D9D9] py-10 rounded-3xl drop-shadow-2xl">
                    ...
                    <form className="space-y-6 pt-5 sm:max-w-sm ml-auto mr-auto" onSubmit={register}>
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <select id="password">
                                    <option value="" className="block w-full rounded-md border-0 py-1.5 px-5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                                    >Please select a qualification</option>
