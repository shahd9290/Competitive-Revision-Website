...
import Page from '@/app/admin/login/page'
...
it('should render login page', () => {
    ...
    expect(screen.getByRole('button', {name: 'Student Login'})).toBeInTheDocument();
...
it('submits user details and redirects on success', async () => {
    ...
    expect(axios.post).toHaveBeenCalledWith(
        ...
        { username: 'user', password: 'password', role: 'ROLE_ADMIN' },
